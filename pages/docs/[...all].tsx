...
import { Alert, AlertIcon, Show } from '@chakra-ui/react'
...
const Docs: FC<DocsProps> = ({ data, content, posts }) => {
  return (
    <>
      ...
      <Box w={{ base: '90%', md: 'container.xl' }} minH={{ base: '90%', md: 'container.lg' }} m='auto' pt={{ base: '16', md: '36' }}>
        <Grid gridTemplateColumns={{ base: '1fr', md: '30% 1fr' }} gridGap='10'>
            ...
            <ReactMarkdown
              components={{
                ...
                code: ({ inline, children }) => {
                  ...
                  return (
                    <Box maxW={{ base: '80', md: 'container.md' }} m='auto' my='8' overflowX='auto' fontSize={{ base: 'sm', md: 'md' }}>
